...
X_train = np.loadtxt("/Users/apple/kerasTest/data/train/test.txt",
                     dtype='float', delimiter='\t', usecols=(0, 1, 2, 3, 4, 5))
Y_train = np.loadtxt("/Users/apple/kerasTest/data/train/test.txt",
                     dtype='float', delimiter='\t', usecols=(6, 7, 8, 9, 10))

X_test = np.loadtxt("/Users/apple/kerasTest/data/train/test.txt",
                    dtype='float', delimiter='\t', usecols=(0, 1, 2, 3, 4, 5))
Y_test = np.loadtxt("/Users/apple/kerasTest/data/train/test.txt",
                    dtype='float', delimiter='\t', usecols=(6, 7, 8, 9, 10))
